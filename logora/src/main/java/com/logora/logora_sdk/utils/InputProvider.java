...
public class InputProvider {
    ...
    public void setListener(InputProviderUpdateListener listener) {
        this.listener = listener;
    }

    public void addUserPosition(Integer debateId, Integer positionId) {
        userPositions.put(debateId, positionId);
    }
    ...
    public Argument getUpdateArgument() {
        return this.updateArgument;
    }

    public void removeUpdateArgument() {
        this.updateArgument = null;
    }
    ...
    public Argument getRemoveArgument() {
        return this.removeArgument;
    }

    public void removeRemoveArgument() {
        this.removeArgument = null;
    }

    public void removeUserPosition(Integer debateId) {
        userPositions.remove(debateId);
    }
