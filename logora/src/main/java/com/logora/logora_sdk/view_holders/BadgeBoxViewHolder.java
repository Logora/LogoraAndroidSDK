...
public class BadgeBoxViewHolder extends ListViewHolder {
    ...
    public void updateWithObject(Object object) {
        ...
        String badgeName = badgeBox.getName();
        int badgeTitleResId;
        ...
        descriptionView.setText(res.getString(badgeDescriptionResId, badgeBox.getSteps(),badgeBox.getSteps() > 1 ? "s" : ""));
        Glide.with(iconView.gegitContext())
